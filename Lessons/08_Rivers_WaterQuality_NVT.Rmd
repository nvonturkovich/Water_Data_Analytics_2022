...
#sig neg slope of flow on conductivity, R2 flow only explains 4% of fecal coliform
...
#sig relationship with flow, explaining 75% of conductivity with flow
...
ggplot(NeuseWQFlow_processed, aes(x = HydrologicCondition, y = FecalColiform_cfu.100mL)) +
  geom_boxplot() +
  facet_wrap(vars(HydrologicCondition), nrow = 7, scales = "free_y") +
  scale_y_log10() +
  labs(x = "Date")
