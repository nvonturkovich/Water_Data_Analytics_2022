...
#10
RI_model_30yr<-lm(data = MysterySite.Annual.30yr, PeakDischarge ~log(RecurranceInterval))
summary(RI_model_30yr)

RI_model_full<-lm(data = MysterySite.Annual.Full, PeakDischarge ~log(RecurranceInterval))
summary(RI_model_full)

RI_model_30yr$coefficients[1] + RI_model_30yr$coefficients[2]*log10(100)
